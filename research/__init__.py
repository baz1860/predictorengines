"""World Cup research/report substrate.

This package was formerly named `wc_v4`. It extends the registered World Cup
engine with report-only modelling research:
