...
def v5_status() -> dict[str, Any]:
    summary = v5_registry.registry_summary()
    drift = _read_json(v5_store.DRIFT_REPORT, {"status": "not_run", "alerts": []})
    return {
...
def daily_run_plan() -> dict[str, Any]:
    steps = [
        ...
        {"id": "v5_report", "command": "python3 -m v5.report",
         "safe": True, "description": "Refresh V5 drift/research summary."},
